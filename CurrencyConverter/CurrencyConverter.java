...
double euroEquivalent= dollarAmount*0.79;
double japaneseyenEquivalent= dollarAmount*108;
 ...
 System.out.printf("\n\t%10s%.2f","euroEquivalent      =   ",euroEquivalent);
 System.out.printf("\n\t%10s%.2f","JapaneseyenEquivalent = ",japaneseyenEquivalent);
	}
}